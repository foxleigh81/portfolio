  ...
  return (
    <footer className={cx(styles['footer'], className)} {...props}>
        <div className={styles['content']}>
          ...
          <p> You can see the roadmap for this site on{' '}
            <a href="http://github.com/foxleigh81/portfolio/issues">Github Issues</a>.
          </p>
        </div>
        <p className={styles['copy']}>
          The content of this site is &copy; {currentYear} Alex Foxleigh. <br /> All rights
          reserved.
        </p>
    </footer>
  );
