    ...
    <Block name="about" className={cx(styles['about'], className)} {...props}>
      <div className={styles.content}>
        ...
        <p>
          ...
          architecture and developer experience as I do about the final product.
        </p>

        <p>
          React, Next.js, Node.js, and Storybook are my tools of choice, I love
          to create design systems and reusable component libraries that
          actually make life easier for the whole team. I like to get stuck in
          from start to finish, shaping the technical direction, mentoring devs,
          and making sure what we&apos;re building is fast, maintainable and
          enjoyable to use.
        </p>
        <p>
