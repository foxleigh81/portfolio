...
const schema = yup.object().shape({
  ...
  message: yup.string().required("If you're contacting me, you should probably have something to say"),
  noSale: yup.boolean().oneOf([true], "Sorry, I'm not buying."),
  botCheck: yup.boolean().oneOf([true], "Sorry, I'm not willing to work for robots just yet.")
});
        ...
        <div className={styles.container}>
          ...
          <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={styles['input-container']}>
              ...
              {errors.contactNumber && <div className={styles.error}>{errors.contactNumber.message}</div>}
            </div>
            ...
            <div className={styles['input-container--checkbox']}>
              ...
              <div>
                ...
                <label htmlFor="noSale">
                  I am not trying to sell you something<Required />
                </label>
              </div>
            ...
            <div className={styles['input-container--checkbox']}>
              {/* TODO: Replace with ReCaptcha */}
              <div>
                <input type="checkbox" id="botCheck" {...register('botCheck')} />
                <label htmlFor="botCheck">
                  I am not a bot<Required />
                </label>
              </div>
              {errors.botCheck && <div className={styles.error}>{errors.botCheck.message}</div>}
            </div>
            
            <button className={cx('btn-primary', styles.button)} type="submit">Submit</button>
          </form>
        </div>
      </div>
    </Block>
