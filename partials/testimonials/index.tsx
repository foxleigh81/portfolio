        ...
        <div className={styles.testimonials}>
          {testimonials.map((testimonial, index) => (
            <div key={index} className={styles.testimonial}>
              <svg className={styles.quoteicon} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 106 75.5">
                <g>
                  <g id="Layer_1">
              ...
              <div className={styles.author}>
                ...
                <div className={styles.role}>{testimonial.role} at {testimonial.company}</div>
              </div>
            </div>
          ))}
